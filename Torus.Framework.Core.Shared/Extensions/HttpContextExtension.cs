...
namespace Torus.Framework.Core.Shared.Extensions;
...
public static partial class HttpContextExtension
{
    ...
    public static bool IsHealthz(this HttpRequest request)
    {
        return request.Path.StartsWithSegments(new PathString("/healthz"));
    }
